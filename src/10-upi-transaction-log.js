...
export function analyzeUPITransactions(transactions) {
  ...
  const frequentContact = Object.entries(contactFrequency).reduce((mostFreq, [contact, count]) => count > mostFreq.count ? { contact, count } : mostFreq, { contact: null, count: -1 }).contact;
